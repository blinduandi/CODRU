...
<body class="antialiased" style="font-family:Futura-Pt Light;">
   ...
   <div class="dropdown-menu">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" height="200px">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="{{ url('/img/1.jpeg') }}" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ url('/img/2.jpeg') }}" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ url('/img/3.jpeg') }}" alt="Third slide">
            </div>
        </div>
        ...
        <div class="card-group">
            ...
            $asd='';
             ...
             $products = DB::table('products')->get();
                ...
                for($i=0;$i<3;$i++){
            $id_d[$i] = $products[(rand(1,$count))-1]->PRODUCTS_ID;
                if($i==1 && $id_d[$i] ==$id_d[$i-1]) $i--;
                if($i==2 && ($id_d[$i] ==$id_d[$i-1] || $id_d[$i] ==$id_d[$i-2]  )) $i--;
        }      
            ...
            for($i =0 ; $i<3 ;$i++){
                ...
                $products = DB::table('products')->where('PRODUCTS_ID',$id_d[$i])->get();
           ...
           echo' <div class="card m-1">
                <img class="card-img-top" src="'.'http://127.0.0.1:8000/public/produse/'.$asd.'" style="  max-width: 75%; height: 75%;width: auto;">
                <div class="card-body" >
